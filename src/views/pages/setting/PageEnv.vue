      ...
      <el-dialog title="BASE_URL信息" :visible.sync="dialogFormVisible">
        <el-form :model="form">
          <el-form-item label="URL名称" label-width="120px">
            <el-input v-model="form.url_name" auto-complete="off"></el-input>
          </el-form-item>
          <el-form-item label="测试环境" label-width="120px">
            <el-input v-model="form.qa_url" auto-complete="off"></el-input>
          </el-form-item>
          <el-form-item label="开发环境" label-width="120px">
            <el-input v-model="form.pro_url" auto-complete="off"></el-input>
          </el-form-item>
          <el-form-item label="项目" prop="project_id" label-width="120px">
            <el-select v-model="form.project_id" @change="onSelectedProDrug($event, form.project_id)" placeholder="" style="width:100%">
        ...
        <div slot="footer" class="dialog-footer">
          ...
          <el-button type="primary" @click="modifyUrl">确 定</el-button>
        </div>
      </el-dialog>
    </el-card>
  </div>
